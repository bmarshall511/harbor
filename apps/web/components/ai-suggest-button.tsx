...
const TONE_OPTIONS = [
  ...
  { value: 'naughty', label: 'Naughty', group: 'Adult' },
  { value: 'x-rated', label: 'X-Rated', group: 'Adult' },
  { value: 'explicit', label: 'Explicit', group: 'Adult' },
  { value: 'porn', label: 'Porn', group: 'Adult' },
  { value: 'erotica', label: 'Erotica', group: 'Adult' },
  { value: 'fetish', label: 'Fetish', group: 'Adult' },
  { value: 'dirty-talk', label: 'Dirty Talk', group: 'Adult' },
  { value: 'taboo', label: 'Taboo', group: 'Adult' },
